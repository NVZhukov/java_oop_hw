...
public class Crossbowman extends Archer {
    ...
    public StringBuilder getInfo() {
        ...
        return builder.append("Арбалет: \t").append(java_oop.homework.hw6.units.Crossbowman.super.name)
                .append("\t\t| ATK:\t").append(java_oop.homework.hw6.units.Crossbowman.super.attack)
