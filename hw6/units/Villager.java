...
public class Villager extends BaseHero {
    ...
    public Villager(String name, int x, int y) {
        super(name, x, y, 50.f,50, 3, 1, 1, 1, 1);
    }

    @Override
    public StringBuilder getInfo() {
        StringBuilder builder = new StringBuilder();
        return builder.append("Фермер: \t").append(java_oop.homework.hw6.units.Villager.super.name)
                .append("\t\t| ATK:\t").append(java_oop.homework.hw6.units.Villager.super.attack)
