package java_oop.homework.hw6;

import java_oop.homework.hw6.units.BaseHero;
...
public class View {
    ...
    private static String getChar(int x, int y){
        String out = "| ";
        for (BaseHero human: Main.allHero) {
            if (human.getCoords()[1] == x && human.getCoords()[0] == y){
    ...
    public static void view() {
        ...
        System.out.print("|    ");
        System.out.print(Main.darkSide.get(0));
        tabSetter(Main.darkSide.get(0).toString().length(), l[0]);
        System.out.println(Main.lightSide.get(0));
        ...
        for (int i = 2; i < 9; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Main.darkSide.get(i-1));
            tabSetter(Main.darkSide.get(i-1).toString().length(), l[0]);
            System.out.println(Main.lightSide.get(i-1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(Main.darkSide.get(9));
        tabSetter(Main.darkSide.get(9).toString().length(), l[0]);
        System.out.println(Main.lightSide.get(9));
