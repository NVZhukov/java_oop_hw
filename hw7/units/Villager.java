...
public class Villager extends BaseHero {
    ...
    public StringBuilder getInfo() {
        ...
        return builder.append("Фермер: \t").append(java_oop.homework.hw7.units.Villager.super.name)
                .append("\t\t| ATK:\t").append(java_oop.homework.hw7.units.Villager.super.attack)
