...
public class Magician extends Priest {
    ...
    public StringBuilder getInfo() {
        ...
        return builder.append("Колдун: \t").append(java_oop.homework.hw7.units.Magician.super.name)
                .append("\t\t| ATK:\t").append(java_oop.homework.hw7.units.Magician.super.attack)
                .append("\t| HP:\t").append(Magician.super.health)
                .append(" \t| MP:\t").append(java_oop.homework.hw7.units.Magician.super.mana)
