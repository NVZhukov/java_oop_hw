...
public class Monk extends Priest {
    ...
    public StringBuilder getInfo() {
        ...
        return builder.append("Монах: \t\t").append(java_oop.homework.hw7.units.Monk.super.name)
                .append("\t\t| ATK:\t").append(java_oop.homework.hw7.units.Monk.super.attack)
                .append("\t| HP:\t").append(Monk.super.health)
                .append(" \t| MP:\t").append(java_oop.homework.hw7.units.Monk.super.mana)
